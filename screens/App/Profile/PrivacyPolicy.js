  ...
  return (
    <ScrollView>
      <View style={styles.viewContainer}>
        ...
        <Text>Last updated: June 04, 2022</Text>
        ...
        <Text>
          ...
          * Application means the software program provided by the Company
          downloaded by You on any electronic device, named EFU APP
        </Text>

        <Text>
          {" "}
          * Company (referred to as either "the Company", "We", "Us" or "Our" in
          this Agreement) refers to EFU APP.
        </Text>

        <Text> * Country refers to: Turkey</Text>
        ...
        <Text>* By email: efu@mail.com</Text>
      </View>
    </ScrollView>
  );
};
